	...
	<form action="" method="post" style="margin: 0px" id="reaver">
		Reaver <select class="input" name="net">
			...
			if (Reaver::checkReaver () > 2) {
				...
				print ' <input type="submit" name="reaver_stop" value="Stop">';
			} else {
				print '<input type="submit" name="reaver_start" value="Start">';
			}
